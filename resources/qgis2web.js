...
map.getView().fit([10569445.015374, 559699.684909, 10724109.413822, 648392.158750], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Peta Rencana Pola Ruang Kabupaten Aceh Besar</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (139 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Peta ini memberikan informasi mengenai rencana pola ruang Kabupaten Aceh Besar berdasarkan data RTRW Kabupaten Aceh Besar Tahun 2012 - 2032';
            }
